...
t_convert() ->
  ...
  ?assertEqual(124, bucs:to_integer("123.5")),
  ?assertEqual(123, bucs:to_integer(<<"123">>)),
  ?assertEqual(123, bucs:to_integer(<<"123.444">>)),
  ?assertEqual(124, bucs:to_integer(<<"123.5">>)),
  ?assertEqual(123, bucs:to_integer('123')),
  ...
  ?assertEqual(124, bucs:to(integer, "123.5")),
  ?assertEqual(123, bucs:to(integer, <<"123">>)),
  ?assertEqual(123, bucs:to(integer, <<"123.444">>)),
  ?assertEqual(124, bucs:to(integer, <<"123.5">>)),
  ?assertEqual(123, bucs:to(integer, '123')),
  ...
  ?assertEqual(124, bucs:as(123, "123.5")),
  ?assertEqual(123, bucs:as(123, <<"123">>)),
  ?assertEqual(123, bucs:as(123, <<"123.444">>)),
  ?assertEqual(124, bucs:as(123, <<"123.5">>)),
  ?assertEqual(123, bucs:as(123, '123')),
...
t_is() ->
  ...
  ?assert(bucs:is_printable("Hello World")),
  ?assert(bucs:is_printable(<<"Hello World">>)),
  ?assertNot(bucs:is_printable(1)),
  ?assertNot(bucs:is_printable([1, 2, 3])),
  ?assertNot(bucs:is_printable(<<1, 2, 3>>)),
  ?assert(bucs:is_list_of_printables(["hello", <<"world">>])),
  ?assertNot(bucs:is_list_of_printables([1, 2, 3])),
  ?assertNot(bucs:is_list_of_printables([1, <<"world">>])),
  ?assertNot(bucs:is_list_of_printables([[1, 2, 3], <<"world">>])),
  ?assertNot(bucs:is_list_of_printables(["hello", 2])),
  ?assertNot(bucs:is_list_of_printables(["hello", <<1, 2, 3>>])),
